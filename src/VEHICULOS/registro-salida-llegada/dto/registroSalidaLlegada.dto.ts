...
import { IAccesoriosSalLle } from 'src/utils/VEHaccesorios-catalago';

export class SalidaLlegadaDTO implements VEHRegistroSalidaLlegada {
  @IsOptional()
  @IsNumber()
  ...
  @IsOptional()
  accesorios: IAccesoriosSalLle; //pendiente de chequeo
}
